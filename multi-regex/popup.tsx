  ...
  return (
    <div style={{
      ...
      {expressions.map((expression, index) => (
        <div key={index} style={{ display: "flex", marginBottom: 12, alignItems: "center" }}>
          <input
          ...
          <div style={{ position: "relative" }}>
            ...
            <div
              onClick={() => setColorPickerIndex(prev => prev === index ? null : index)}
              style={{
                width: 40,
                height: 40,
                ...
                {colorOptions.map((col) => (
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: 3,
                      cursor: "pointer",
                      border: col === expression.color ? "2px solid #333" : "1px solid #ccc"
                    }}
                  />
                ))}
              </div>
